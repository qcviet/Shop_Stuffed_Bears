    ...
    <body>
        ...
        if ($secureHash == $vnp_SecureHash && $_GET['vnp_ResponseCode'] == '00') {
            if ($order && $order['payment_status'] != 'Đã thanh toán') {
                ...
                if ($updateResult) {
                    error_log("VNPay Return: Order #$orderId payment status updated to 'Đã thanh toán'");
                }
            }
        }
        ?>
        ...
        <div class="container">
            ...
            <div class="text-center">
                <a href="http://localhost/shopgauyeu/" class="btn btn-primary">Quay về trang chủ</a>
                <a href="http://localhost/shopgauyeu/admin/" class="btn btn-success">Vào trang Admin</a>
            </div>
            <p>
                &nbsp;
            </p>
